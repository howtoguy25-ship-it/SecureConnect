...
// Mirrors web/src/services/liveTrafficCameras.ts exactly.
//
...
// appending a cache-busting query param on each refresh is what actually forces a fresh
// fetch instead of reusing whatever's already cached for that URL.
