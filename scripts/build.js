...
async function downloadFile(url, outputPath) {
  ...
  // Increased timeout to 10 minutes for production bundle generation
...
async function downloadManifest(platform) {
  const controller = new AbortController();
  // Increased timeout to 10 minutes for production manifest generation
  const timeoutId = setTimeout(() => controller.abort(), 600_000);
...
async function main() {
  ...
  // Increased overall timeout to 15 minutes for production builds
